...
namespace Sep12
{
    internal class Program
    {
        ...
        {
            string path = @"D:\C#\Sep12\Calculator\bin\Debug\Calculator.dll";
            ...
            foreach (var item in types)
            {
                ...
                double ans1 = (double)item.InvokeMember("sqrt", BindingFlags.Public | BindingFlags.Instance | BindingFlags.InvokeMethod, null, obj, new object[1] { 2 });
